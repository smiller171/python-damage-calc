$(function() {
    ...
    function calc_hit() {
        ...
        $.ajax({
            url : "calc_hit/", // the endpoint
            type : "POST", // http method
            data : {
                shootingSkill : $('#shootingSkill').val(),
                shootingRange : $('#shootingRange').val(),
                cover : $('#cover').val(),
                specialized : $("input[name=specialized]:checked").val(),
                mods : $('#mods').val(),
            ...
            success : function(json) {
                ...
                $('#rollResult').text(json.rollResult);
